...
@injectable()
class GetAllEquipmentCategoriesController implements BaseController {
    constructor(
    ...
    async Handle(req: Request, res: Response) {
        try {
            ...
            const result = await this.equipmentCategoryServices.GetAllAsync()
...
export default GetAllEquipmentCategoriesController
