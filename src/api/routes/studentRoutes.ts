...
studentRoutes.put("/term", EnsureCorrectFieldsValidationMiddleware(UpdateStudentTermPayload), EnsureUserRoleMiddleware([AccountType.student]), async (req, res) => updateStudentTermController.Handle(req, res))
studentRoutes.put("/shift", EnsureCorrectFieldsValidationMiddleware(UpdateStudentShiftPayload), EnsureUserRoleMiddleware([AccountType.student]), async (req, res) => updateStudentShiftController.Handle(req, res))
