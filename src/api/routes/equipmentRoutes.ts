...
const getEquipmentAvailabilityByCategoryController = container.resolve<BaseController>("GetEquipmentAvailabilityByCategoryController")
const getEquipmentAvailabilityByLaboratoryController = container.resolve<BaseController>("GetEquipmentAvailabilityByLaboratoryController")
