...
borrowRoutes.get("/", EnsureAuthenticatedUserMiddleware, (req, res) => getAllBorrowsController.Handle(req, res))
borrowRoutes.get("/:id", EnsureAuthenticatedUserMiddleware, (req, res) => getBorrowByIdController.Handle(req, res))
